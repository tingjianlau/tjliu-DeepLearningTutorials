...
datapath = ['data_daily/data_features/ifly_train_finetune', 'data_daily/data_features/ifly_val_finetune', 'data_daily/data_features/ifly_test_finetune'] 
data_y_path = ['data_daily/data_features/train_set_y', 'data_daily/data_features/val_set_y', 'data_daily/data_features/test_set_y'] 
#datapath = ['data_daily/ifly_train', 'data_daily/ifly_test', 'data_daily/ifly_val'] 
#datapath = ['data_daily/000001/train.txt', 'data/000001/val.txt', 'data/000001/test.txt'] 
#datapath = [
...
def my_load_data(path_x, path_y):
    data = open(path_x, 'r')
    prices = []
    for line in data:
...
def sgd_optimization_mnist(learning_rate=LEARNING_RATE, n_epochs=N_EPOCHS,
                           dataset=datapath,
                           batch_size=BATCH_SIZE, axis_1=0, axis_2=1):
    """
    ...
    train_set_x, train_set_y = my_load_data(datapath[0], data_y_path[0])
    ...
    valid_set_x, valid_set_y = my_load_data(datapath[1], data_y_path[1])
    ...
    test_set_x, test_set_y = my_load_data(datapath[2], data_y_path[2])
