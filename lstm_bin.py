...
SEQ_LENGTH = 1      # how many steps to unroll
...
train ='data_daily/000001/data_000001_train'
val = 'data_daily/000001/data_000001_val'
test = 'data_daily/000001/data_000001_test'
...
if __name__ == '__main__':
    print('the current seq_length is {}'.format(SEQ_LENGTH))
